...
//    //            dataType: "json"
//    //        }).done(function (data) {
//    //            console.log('پیغام زیر ماژول من است');
//    //            //var funcBody = data.Circuit.match(/function[^{]+\{([\s\S]*)\}$/)[0];
//    //            //var newFunc = new Function(funcBody);
//    //            //var obj2 = JSON.parse(data.Circuit, function (key, value) {
...
//    //        };
//    //    };
//    //    xmlhttp.open("POST", "http://localhost:7000/", true);
//    //    xmlhttp.send(formdata);
//    //    return false;
//    //}
//    // جهت تست گذاشته شده با رفرش صفحه ارسال شود
//    //console.log(module);
//    return module;
//};
